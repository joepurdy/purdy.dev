...
tags = ["webdev", "docker", "caddy", "go"]
keywords = ["webdev", "docker", "caddy", "go"]
description = "A quick how-to on how I'm using Caddy 2 for local Go development with HTTPS and dynamic reloading."
showFullContent = false

[cover] 
    url = "/uploads/go_gopher.jpg"
    caption = 'Photo by <a href="http://reneefrench.blogspot.com/?utm_source=purdy.dev&utm_medium=referral&utm_content=creditCopyText">Renee French</a> on <a href="https://commons.wikimedia.org/wiki/File:The_Go_Gopher.jpg?utm_source=purdy.dev&utm_medium=referral&utm_content=creditCopyText">Wikimedia Commons</a>'
+++
...
{{< image src="https://s3-us-west-2.amazonaws.com/cdn.purdy.dev/yo_joe_http.png" width=300 alt="Basic Go Server" >}}
...
{{< image src="https://s3-us-west-2.amazonaws.com/cdn.purdy.dev/yo_joe_http.png" width=300 alt="Yo Joe! Go Server (in a container)" >}}
...
{{< image src="https://s3-us-west-2.amazonaws.com/cdn.purdy.dev/yo_joe_http.png" width=300 alt="Yo Joe! Go Server (in a container w/ dynamic reload)" >}}
...
{{< image src="https://s3-us-west-2.amazonaws.com/cdn.purdy.dev/yo_jane_http.png" width=300 alt="Yo Jane! Go Server (in a container)" >}}
...
{{< image src="https://s3-us-west-2.amazonaws.com/cdn.purdy.dev/yo_https.png" width=300 alt="Yo HTTPS! Go Server (in a container w/ HTTPS)" >}}

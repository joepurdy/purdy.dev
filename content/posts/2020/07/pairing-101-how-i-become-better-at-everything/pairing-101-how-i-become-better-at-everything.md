+++
title = "Pairing 101 - How I become better at everything"
date = 2020-07-21T16:00:00Z
author = "Joe Purdy"
authorTwitter = "polyglotpurdy"
tags = ["remote-work", "meta"]
keywords = ["remote work", "pair programming"]
...
[cover] 
    url = "/uploads/shumilov-ludmila-j7X_hySaUa4-unsplash.jpg"
    caption = 'Photo by <a href="https://unsplash.com/@lsfineartphotography?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Shumilov Ludmila</a> on <a href="https://unsplash.com/s/photos/pair?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a>'
+++
...
* Video conferencing - This is a major 🔑 for pairing. All my pairing is remote and happens over video calls with screen-sharing. I've used Screenhero (RIP), Slack, Zoom, [Screen.so](http://screen.so?ref=purdy.dev), and MS Teams. If I had to pick the one that worked best I'd go with [Screen.so](https://screen.so?ref=purdy.dev), but honestly they all do a good enough job.
...
* A wiki - The aforementioned ideas doc lives in whatever wiki exists where I work. I've used [Notion.so](http://notion.so?ref=purdy.dev) and Confluence primarily.
